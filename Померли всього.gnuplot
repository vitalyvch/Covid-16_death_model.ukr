...
###
fit [80:179][0:3000] F0(x) 'data.dat' u 1:3 via 'Померли всього-start0.par'
...
plot [62:275] \
	...
	(x<184 ? 1 : abs(F1(x)-F0(x))) with lp axes x1y2 t "«EXTRA», non-COVID deaths, guess #1   ---   RIGHT SCALE   ---   abs(F1(x)-F0(x))", \
...
#	(x<184 ? 1 : abs(F2(x)-F0(x))) with lp axes x1y2 t "«EXTRA», non-COVID deaths, guess #2   ---   RIGHT SCALE   ---   abs(F2(x)-F0(x))", \
#	(x<184 ? 1 : abs(F3(x)-F0(x))) with lp axes x1y2 t "«EXTRA», non-COVID deaths, guess #3   ---   RIGHT SCALE   ---   abs(F3(x)-F0(x))", \
#	(x<184 ? 1 : abs(F4(x)-F0(x))) with lp axes x1y2 t "«EXTRA», non-COVID deaths, guess #4   ---   RIGHT SCALE   ---   abs(F4(x)-F0(x))"
